...
const ET = {
  ...
  cs: {
    ...
    alert_state: "Hodnota",
    alert_state_help: "např. 'on', '80' (čísla s možností > < >= <=)",
    ...
    alert_attribute_help: "např. battery_level. Ponechte prázdné empty pro použití stavu entity. Podporuje vnořené cesty k atributu: např. activity.0.forecast",
